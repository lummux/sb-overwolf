 ...
 * https://github.com/itssimple/overwolf-event-dispatcher
 */
...
const OverwolfGameSupportedEvents = {
    ...
    Fortnite: ['gep_internal', 'kill', 'killed', 'killer', 'revived', 'death', 'match', 'match_info', 'rank', 'me', 'phase', 'location', 'team', 'items', 'counters'],
...
class OverwolfEventDispatcher {
    ...
    static gameInfoUpdated(event) {
        ...
        OverwolfEventDispatcher.sendDataToWebsocket('GameInfoUpdated', event);
    ...
    static gameEventError(event) {
        ...
        OverwolfEventDispatcher.sendDataToWebsocket('GameEventError', event);
    }
    ...
    static gameEventUpdated2(event) {
        ...
        OverwolfEventDispatcher.sendDataToWebsocket('GameEventInfoUpdated2', event);
    }
    ...
    static gameEvents(event) {
        ...
        OverwolfEventDispatcher.sendDataToWebsocket('GameEventNewEvents', event);
    }
};
